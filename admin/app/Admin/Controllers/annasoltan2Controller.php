...
use \App\Models\annasoltan2;

class annasoltan2Controller extends AdminController
{
    /**
    ...
    {
        $show = new Show(annasoltan2::findOrFail($id));
