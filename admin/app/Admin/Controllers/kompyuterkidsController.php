...
use \App\Models\kompyuterkids;

class kompyuterkidsController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new kompyuterkids());
    ...
    {
        $show = new Show(kompyuterkids::findOrFail($id));
    ...
    {
        $form = new Form(new kompyuterkids());
