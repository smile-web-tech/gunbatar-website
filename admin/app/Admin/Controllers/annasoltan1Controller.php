...
use \App\Models\annasoltan1;

class annasoltan1Controller extends AdminController
{
    /**
    ...
    {
        $show = new Show(annasoltan1::findOrFail($id));
