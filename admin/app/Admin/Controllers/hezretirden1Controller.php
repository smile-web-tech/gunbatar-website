...
use \App\Models\hezretirden1;

class hezretirden1Controller extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new hezretirden1());
    ...
    {
        $show = new Show(hezretirden1::findOrFail($id));
    ...
    {
        $form = new Form(new hezretirden1());
