...
use \App\Models\annagozel2;

class annagozel2Controller extends AdminController
{
    /**
    ...
    {
        $show = new Show(annagozel2::findOrFail($id));
