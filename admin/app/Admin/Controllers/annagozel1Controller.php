...
use \App\Models\annagozel1;

class annagozel1Controller extends AdminController
{
    /**
    ...
    {
        $show = new Show(annagozel1::findOrFail($id));
