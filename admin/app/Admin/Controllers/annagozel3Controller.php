...
use \App\Models\annagozel3;

class annagozel3Controller extends AdminController
{
    /**
    ...
    {
        $show = new Show(annagozel3::findOrFail($id));
