...
use \App\Models\yazgylych2;

class yazgylych2Controller extends AdminController
{
    /**
    ...
    {
        $show = new Show(yazgylych2::findOrFail($id));
