...
class nartach2Controller extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new nartach2Model());
    ...
    {
        $show = new Show(nartach2Model::findOrFail($id));
    ...
    {
        $form = new Form(new nartach2Model());
