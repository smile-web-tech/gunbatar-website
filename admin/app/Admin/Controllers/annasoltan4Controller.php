...
use \App\Models\annasoltan4;

class annasoltan4Controller extends AdminController
{
    /**
    ...
    {
        $show = new Show(annasoltan4::findOrFail($id));
